...
<!--                    </div>-->
                ...
                <div class="col-lg-6 form-inner-cont">
                    <div class="title-content text-left">
                        <h3 class="hny-title mb-lg-5 mb-4">Admin Login</h3>
                    </div>
                    <form action="Action/Adminloginaction.php" method="post" class="signin-form">
                        <div class="form-input">
                            <input type="email" name="email" id="w3lName" placeholder="email" required/>
                        </div>
                       <div class="form-input">
                           <input type="password" name="password" id="w3lName" placeholder="Password" required/>
                        </div>
